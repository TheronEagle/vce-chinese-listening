...
export function PracticePage() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 pt-4 pb-8">
      ...
      {/* Listening Notes — visible during practice, hidden after results */}
      <div className="mb-4">
        <ListeningNotes
          exerciseId={exercise.id}
      ...
      {/* Transcript lock warning */}
      {!showingResults && !transcriptRevealed && (
        <div className="mb-4 flex items-center gap-2 px-4 py-3 bg-gray-50 rounded-xl border border-gray-200">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" className="text-gray-400"><path d="M9.88 9.88a3 3 0 1 0 4.24 4.24"/><path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68"/><path d="M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61"/><line x1="2" x2="22" y1="2" y2="22"/></svg>
          <p className="text-sm text-gray-500">
            完成所有题目后才能查看原文
            <br />
            <span className="text-xs text-gray-400">Transcript will be revealed after completing all questions</span>
          </p>
        </div>
      )}
      ...
      {showingResults ? (
        <>
          ...
          {/* Transcript (revealed after results) */}
          <div className="mt-6">
            <div className="flex items-center gap-2 mb-3">
              <BookOpen size={18} className="text-blue-600" />
              <h3 className="font-semibold text-gray-700">听力原文 Transcript</h3>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" className="text-green-500"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>
            </div>
